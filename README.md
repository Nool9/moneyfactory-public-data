# PIT ledger public-only v6

Pinned Cloud Run implementation for the PIT ledger public-only v6 contract.
...
The container clones and writes only `pit-ledger-public-v6` and fails closed
