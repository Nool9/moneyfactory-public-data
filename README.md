# PIT ledger public-only v7

Pinned Cloud Run implementation for the PIT ledger public-only v7 contract.
...
The container clones and writes only `pit-ledger-public-v7` and fails closed
