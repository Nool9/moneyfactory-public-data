# PIT ledger public-only v5

Pinned Cloud Run implementation for the PIT ledger public-only v5 contract.
...
The container clones and writes only `pit-ledger-public-v5` and fails closed
